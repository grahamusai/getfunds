            ...
            <div className="w-full sm:w-1/2 border bg-green-500 px-5 py-3">
              ...
              <div className="p-5 mt-3">
                ...
                <p className="text-sm">
                  ...
                  Dolorem maxime dicta repudiandae veniam molestias inventore
                  assumenda adipisci! Aspernatur officiis tempora ipsa sit
                  nostrum voluptatum? Reprehenderit, molestias tempore. Iure,
                  pariatur eveniet?
                </p>
              </div>
            </div>
