          ...
          <div className=" lg:hidden bg-green-500 border border-slate-900 p-6 mx-2 rounded mt-2">
            <div className="flex flex-row sm:flex-row ">
              <div className="w-full ">
                ...
                <h1 className="py-1 px-1 bg-slate-600  text-white text-xs text-center rounded-full mt-5">90% Approval <br></br> rate</h1>
              </div>
              <div className="w-full border-l-2 border-slate-900 pl-10">
                ...
                <h1 className="py-1 px-1 bg-slate-600  text-white text-xs text-center rounded-full mt-5">1-3 days turnaround time</h1>
